          ...
          <div className="flex justify-between items-center py-3">
            ...
            <div className="flex items-center">
              ...
              <div className="flex items-center bg-black/30 rounded-full px-3 py-1">
                <div className="h-2 w-2 bg-minecraft-green rounded-full mr-2 animate-pulse"></div>
                <span className="text-gray-300 text-xs sm:text-sm">42 PLAYERS ONLINE NOW</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="lg:grid lg:grid-cols-12 lg:gap-12">
            ...
            >
              <div className="relative mx-auto w-full">
                ...
                {/* Minecraft-styled server info box with side-positioned Bizzy */}
                <div className="relative rounded-lg bg-minecraft-navy-dark border-[3px] border-minecraft-green/90 shadow-2xl py-6 px-7">
                  {/* Minecraft texture overlay */}
                  <div className="absolute inset-0 minecraft-dirt-bg opacity-10 rounded-lg"></div>
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="text-center mb-5">
                      <h3 className="font-minecraft text-3xl text-minecraft-green">
                        SERVER INFO
                      </h3>
                    </div>
                    
                    {/* Main server address with Minecraft styling */}
                    <div className="bg-black/80 border-[3px] border-minecraft-green/80 rounded-md p-4 mb-6">
                      <div className="text-center">
                        <div className="font-minecraft text-sm text-gray-300 mb-1">SERVER ADDRESS</div>
                        <div className="font-minecraft text-2xl text-minecraft-green tracking-wide mb-2">
                          play.bizzynation.co.uk
                        </div>
                        <div className="flex justify-center">
                          <button 
                            className={`px-4 py-2 rounded font-minecraft text-sm transition-all duration-300 ${
                              copySuccess 
                                ? 'bg-minecraft-green text-white' 
                                : 'bg-black/50 border-2 border-minecraft-green/60 text-minecraft-green hover:bg-black'
                            }`}
                    ...
                    {/* Server info in Minecraft style blocks */}
                    <div className="grid grid-cols-3 gap-3 mb-7">
                      <div className="bg-black/60 border-2 border-minecraft-green/60 rounded p-3 text-center">
                        <div className="font-minecraft text-gray-300 text-xs">VERSION</div>
                        <div className="font-minecraft text-minecraft-green text-lg mt-1">1.19.2</div>
                      </div>
                      <div className="bg-black/60 border-2 border-minecraft-green/60 rounded p-3 text-center">
                        <div className="font-minecraft text-gray-300 text-xs">PLAYERS</div>
                        <div className="font-minecraft text-minecraft-green text-lg mt-1">42/100</div>
                      </div>
                      <div className="bg-black/60 border-2 border-minecraft-green/60 rounded p-3 text-center">
                        <div className="font-minecraft text-gray-300 text-xs">STATUS</div>
                        <div className="flex items-center justify-center mt-1">
                          <span className="h-3 w-3 bg-minecraft-green rounded-full mr-2 animate-pulse"></span>
                          <span className="font-minecraft text-minecraft-green text-lg">ONLINE</span>
                        </div>
                      </div>
                    </div>
                    
                    {/* Large JOIN SERVER button in Minecraft style - kept as requested */}
                    <div className="btn-3d w-full scale-105 transform">
                      <button 
                        className="minecraft-btn w-full rounded-md py-5 text-xl font-minecraft flex items-center justify-center"
                        onClick={copyServerAddress}
                      >
                        <div className="flex items-center">

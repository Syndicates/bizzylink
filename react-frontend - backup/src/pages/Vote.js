...
const Vote = () => {
  ...
  useEffect(() => {
    // Use the new helper from AuthContext to determine link status
    ...
    console.log("User linked status:", user?.linked);
    console.log("User mcUsername:", user?.mcUsername);
        ...
        <div className="grid grid-cols-1 gap-4">
          ...
          {rewardItems.map((item, index) => (
            ...
            >
              ...
              <div className="flex justify-center">
                <MinecraftItem name={item.icon} size={32} animate={false} />
              </div>
